...
def main():
    ...
    gray_input_dir = '/mnt/SSD/cyx/DATASET/instance_color/val_gray_7213_resized_512'
    # whole_cations_dir = '/mnt/SSD/cyx/CogVLM2/output/final_merged_json/val'

    # filename_list_to_test = get_filenames(gray_input_dir)
    filename_list_to_test = get_filename_list_to_test('/mnt/SSD/cyx/L-CAD-main/resources/cap-img-pairs_val_simple_7k.json')
    filename_list_to_test = get_filename_list_to_test(f'/mnt/SSD/cyx/L-CAD-main/resources/instances/split_test_captions/part{split_num}.json')

    input_original_color_caption_dir = '/mnt/SSD/cyx/L-CAD-main/resources/cap-img-pairs_val_simple_7k.json'  # multi-instance
    input_color_caption_pred_from_gray_dir = '/mnt/SSD/cyx/DATASET/instance_color/instances_val7k_color_pred_text_based_20251105.json'
    input_style_caption_pred_from_gray_dir = '/mnt/SSD/cyx/DATASET/instance_color/instances_val7k_style_pred_20251105.json'
    input_light_caption_pred_from_gray_dir = '/mnt/SSD/cyx/DATASET/instance_color/instances_val7k_light_pred_20251105.json'
    input_material_caption_pred_from_gray_dir = '/mnt/SSD/cyx/DATASET/instance_color/instances_val7k_material_pred_20251105.json'
    ...
    with torch.inference_mode():
        ...
        loraloader_193 = loraloader.load_lora(
            lora_name="finetune_multi_instances_from_coco_2-4-20855.safetensors",
        ...
        input_original_color_caption_data = load_json_file(input_original_color_caption_dir)
        ...
        for filename in filename_list_to_test:
            ...
            input_original_color_caption = input_original_color_caption_data[filename]
            ...
            print('Colorize this to a vivid colorful image following the COLOR:' + input_color_caption_pred_from_gray + input_original_color_caption + ' ' + input_style_caption_pred_from_gray + ' ' + input_light_caption_pred_from_gray + ' ' + input_material_caption_pred_from_gray,
)
            ...
            cliptextencode_6 = cliptextencode.encode(
                # text='Colorize this to a vivid colorful image following the COLOR:' + input_color_caption_pred_from_gray + input_original_color_caption + ' ' + input_style_caption_pred_from_gray + ' ' + input_light_caption_pred_from_gray + ' ' + input_material_caption_pred_from_gray,
            ...
            easy_imagesave_234 = easy_imagesave.save(
                filename_prefix=f"{filename}_all_lora_instance",
                only_preview=False,
