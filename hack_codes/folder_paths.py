...
# output_directory = os.path.join(base_path, "output_all_lora_without_M_module_pred_using_ori_coco_prompt_into_4_lora")
# output_directory = os.path.join(base_path, "output_COCO_text_4_all_pred_new")  # unified start prompt colorize this...
# output_directory = os.path.join(base_path, "output_COCO_auto_4_all_pred_new")
output_directory = os.path.join(base_path, "output_COCO_text_4_all_pred_new2_a_vivid")  # a vivid colorful image
# output_directory = os.path.join(base_path, "output_all_lora_without_M_module_pred_using_change_to_a_colorful_image_prompt")
# output_directory = os.path.join(base_path, "output_all_lora_without_M_module_pred_using_empty_prompt")
# output_directory = os.path.join(base_path, "output_all_lora_imagenet_finetuned_pred_color_fully_trained_qwen_pred_color_step915_90_5_5_5")
# output_directory = os.path.join(base_path, "output_all_lora_imagenet_finetuned_pred_color_fully_trained_qwen_pred_color_step915_100_5_5_5")
# output_directory = os.path.join(base_path, "output_all_lora_instance_finetuned_pred_color_step1400_epoch_7")
#"output_all_lora_imagenet_finetuned_pred_color_step1400" output_all_lora_instance_finetuned_pred_color_step1400
# ## fixed  "output" output_ori_COCO_lora_ablation
